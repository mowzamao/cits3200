...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.main_layout.addWidget(self.control_panel, 0, 0, rowSpan = 2, columnSpan[, alignment=Qt.Alignment()])
        self.main_layout.addWidget(self.image_panel, 1, 1)
        self.main_layout.addWidget(self.graph_panel, 1, 2)
