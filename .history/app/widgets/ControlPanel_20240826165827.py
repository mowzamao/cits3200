from PyQt6.QtWidgets import QWidget, QHBoxLayout, addWidget, QPushButton
...
class ControlPanel(QWidget):
    ...
    def init_ui(self):
        ...
        self.layout.addWidget(grayscale_button)
        self.layout.addWidget(rgb_analysis_button)
        self.layout.addWidget(perimeter_detection_button)
        self.layout.addWidget(set_calibration_button)
        self.layout.addWidget(export_data_button)
        self.layout.addWidget(plot_rgb_graph_button)
        self.layout.addWidget(plot_greyscale_button)
