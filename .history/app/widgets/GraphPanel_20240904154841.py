from PyQt6.QtWidgets import QWidget,  QHBoxLayout, QGridLayout, QLabel
...
class GraphPanel(QWidget):
    ...
    def init_ui(self):
        ...
        main_layout.addWidget(title_label, 0, 4, 2, 2, Qt.AlignmentFlag.AlignTop)

        graphs_layout = QHBoxLayout()
        channels = ["Red", "Green", "Blue"]
        for i, colour in enumerate(channels):
            graph = MplCanvas(self, width=4, height=5, dpi=100)
            graph.setStyleSheet("padding: 5px; border: 1px solid black; color: black; background-color: white;")
