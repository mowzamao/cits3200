...
class GraphPanel(QWidget):
    ...
    def init_ui(self):
        ...
        graph.axes[0].plot(round(100*df['Red']/255,  4), df['Depth'],  color='red')
        graph.axes[1].plot(round(100*df['Green']/255,4), df['Depth'],color='green')
        graph.axes[2].plot(round(100*df['Blue']/255, 4), df['Depth'], color='blue')
