...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.main_layout.addWidget(self.control_panel, 0, 0, rowSpan = 2, columnSpan= 1)
        self.main_layout.addWidget(self.image_panel, 3, 1)
        self.main_layout.addWidget(self.graph_panel, 3, 2)
