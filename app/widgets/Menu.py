...
import cv2 as cv
import numpy as np
from app.widgets.ImageFormatting import orient_array, img_rgb_array, img_lab_array  # Import functions assuming the formatting file is in the widgets folder, can be changed later.
