...
class GraphsToolbar(NavigationToolbar):
    ...
    def add_units_button(self):
        units_svg = """<svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 0 24 24" width="20px" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><rect width="100%" height="100%" fill="#f3f2f0" /> <path d="M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 10H3V8h2v4h2V8h2v4h2V8h2v4h2V8h2v4h2V8h2v8z"/></svg>"""
        self.units_action = QAction("Change Units", self, icon = self.svg_to_icon(units_svg))
        self.insertAction(self.actions()[6], self.units_action)
        self.units_action.triggered.connect(self.toggle_units)
